@echo off
@shift /0
string batContent = File.ReadAllText(tempPath1);
Console.WriteLine($"Content of BAT file:{Environment.NewLine}{batContent}");
...
netsh winsock reset 
netsh advfirewall reset 
del /s /q /f /a:h /a:a "%systemdrive%\Users\%username%\cleaner.bat